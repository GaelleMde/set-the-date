...
function AllEventCard(props) {
  ...
  const isFavorite = props.favorites.some(
    (eachFav) => eachFav._id === props.eachEvent._id
  );
  ...
  const startDate = new Date(props.eachEvent.startDate);
  const endDate = new Date(props.eachEvent.endDate);
        ...
        <div className="all-event-card-data-img">
          ...
          <div className="all-event-card-content">
            <div className="all-event-card-data">
              ...
              <p>
                <i class="bi bi-calendar3"></i> {formatDate(startDate, endDate)}
              </p>
              <p>
                <i class="bi bi-geo-alt"></i> {props.eachEvent.city},{" "}
                {props.eachEvent.country}{" "}
              </p>
            </div>
          </div>
        </div>
